      ...
      {/* DARREN'S CONTAINER */}
          <div className="theSongsBody">
            <div className="theSongsContainer">
              ...
              <iframe width="100%" height="150" scrolling="no" frameBorder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/254061767&ampauto_play=false&amphide_related=false&ampshow_comments=true&ampshow_user=true&ampshow_reposts=false&ampvisual=true" />
              <div className="songtitle">{'I\'ll Be Loving You (Forever)'}</div>
              <iframe width="100%" height="150" scrolling="no" frameBorder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/254061733&ampauto_play=false&amphide_related=false&ampshow_comments=true&ampshow_user=true&ampshow_reposts=false&ampvisual=true" />
              <div className="songtitle">Cover Girl</div>
              <iframe width="100%" height="150" scrolling="no" frameBorder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/254061733&ampauto_play=false&amphide_related=false&ampshow_comments=true&ampshow_user=true&ampshow_reposts=false&ampvisual=true" />
              <div className="tvtitle">The gang on TV!</div>
              <iframe width="420" height="315" frameBorder="0" allowFullScreen src="https://www.youtube.com/embed/_rCnxuu1T9g" />
            </div>
          </div>
        </div>
         {/* DARREN'S CONTAINER */}
